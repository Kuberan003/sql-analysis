...
### 2️⃣ Taxi Data Analysis
- **Folder:** `Project2_Taxi_Data/`
- **Description:** Analyze taxi trip data including driver performance, daily trends, and distance-based insights.  
- **Files:** `analysis.sql` + `taxi.csv`
